...
pub fn builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        commands::access::library_access_retry,
        commands::access::library_recovery_start_fresh,
        commands::access::library_lock,
        commands::access::library_unlock,
        commands::backup::backup_create,
        commands::backup::backup_create_portable,
        commands::backup::backup_automatic_status,
        commands::backup::backup_automatic_configure,
        commands::backup::backup_automatic_disable,
        commands::backup::backup_prepare_restore,
        commands::backup::backup_prepare_portable_restore,
        commands::backup::backup_recovery_prepare,
        commands::backup::backup_recovery_restore,
        commands::backup::backup_restore,
        commands::backup::backup_restore_status,
        commands::storage::storage_status,
        commands::storage::storage_migrate_select,
        commands::storage::storage_reconnect_select,
        commands::storage::storage_migration_receipt,
        commands::diagnostics::diagnostics_export,
        commands::ocr_capability::ocr_capability_status,
        commands::ocr_capability::ocr_component_install,
        commands::ocr_capability::ocr_component_remove,
        commands::system::system_status,
        commands::updates::windows_update_status,
        commands::updates::windows_update_check,
        commands::updates::windows_update_install,
        ...
        commands::library::problem_filter_options,
        ...
        commands::capture_recognition::capture_recognition_start,
        commands::capture_recognition::capture_recognition_status,
        commands::capture_recognition::capture_recognition_review,
        commands::capture_recognition::capture_recognition_cancel,
