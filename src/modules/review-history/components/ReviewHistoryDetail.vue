...
onMounted(() => {
  ...
  if (mobile.value) {
    if (detailLayer.value) {
      releaseDialogBoundary = acquireDialogDocumentBoundary(detailLayer.value)
    }
