...
import { Archive, BookOpen, Image, Plus, Search } from '@lucide/vue'
...
.card-link { display: flex; justify-content: space-between; width: 100%; margin-top: 20px; padding: 14px 0 0; color: var(--ink-muted); border: 0; border-top: 1px solid var(--line); background: transparent; text-align: left; }
