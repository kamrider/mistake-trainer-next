...
describe('generated Tauri bindings', () => {
  it('contains the registered system command and public result contract', async () => {
    ...
    expect(bindings).toContain('DashboardOverview')
    expect(bindings).toContain('WeakAreaSummary')
    expect(bindings).toContain('DueForecastDay')
    expect(bindings).toContain('reportSummary: (utcOffsetMinutes: number) =>')
    ...
    expect(bindings).toContain('storageStatus: () =>')
    expect(bindings).toContain('storageMigrateSelect: () =>')
    expect(bindings).toContain('storageMigrationReceipt: () =>')
    expect(bindings).toContain('StorageLocationStatus')
    expect(bindings).toContain('StorageMigrationReceipt')
    expect(bindings).not.toContain('storageMigrateSelect: (path:')
    ...
    expect(bindings).not.toContain('problemList: (status: ProblemStatusFilter')
