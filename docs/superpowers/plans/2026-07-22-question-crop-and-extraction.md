...
**Status:** Desktop implementation complete. Remaining Phase 1 work is phone quick-crop design plus real-device acceptance; do not replace the existing crop ledger or editor.
